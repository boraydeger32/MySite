...
export default function SiparislerError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    console.error('[Siparisler Error]', error);
  }, [error]);
    ...
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="mt-2 max-w-md text-sm text-text-muted">
          Siparis verileriniz yuklenirken bir hata olustu.
          Canli baglanti kesilmis olabilir. Lutfen tekrar deneyin.
        </p>
